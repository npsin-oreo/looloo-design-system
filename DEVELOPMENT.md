...
เอกสารนี้สำหรับผู้ดูแล `@looloo/design-system` ที่ต้องเพิ่มหรือแก้ component, design tokens และ release package
...
ไฟล์ `components/ui/<name>.tsx` จะถูก export อัตโนมัติเป็น `@looloo/design-system/<name>` ผ่าน wildcard export ใน `package.json`
...
```tsx
import { StatusCard } from "@looloo/design-system/status-card"
```
