...
/**
 * Dismiss the popover from inside it. A popover already closes on outside-click
 * and Escape, so this is for the cases where neither is discoverable — a popover
 * holding a form, or one a touch user opened.
 */
...
/** Actions, aligned right. Keep it to two: a popover is not a dialog. */
function PopoverFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="popover-footer"
      className={cn(
        "flex items-center justify-end gap-(--popover-footer-gap)",
        className
      )}
      {...props}
    />
