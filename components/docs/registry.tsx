...
export const registry: DocEntry[] = [
  ...
  // ───────────────────────── AI & Chat ─────────────────────────
  c("chat", "Chat", "AI & Chat", "Assistant-UI primitives — a role-aware message list, sender-aligned bubbles, metadata, system notices, and a composer with send/stop and optional dictation.",
    <div className="flex w-full max-w-md flex-col gap-3">
      <ChatMessageList className="h-72 rounded-lg border" density="balanced">
